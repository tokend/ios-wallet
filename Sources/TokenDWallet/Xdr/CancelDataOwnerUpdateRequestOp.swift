...
//  ===========================================================================
public struct CancelDataOwnerUpdateRequestOp: XDRCodable {
  public var requestID: Uint64
  public var ext: CancelDataOwnerUpdateRequestOpExt

  public init(
      requestID: Uint64,
      ext: CancelDataOwnerUpdateRequestOpExt) {
  ...
  public init(xdrData: inout Data) throws {
    ...
    self.ext = try CancelDataOwnerUpdateRequestOpExt(xdrData: &xdrData)
  }

  public enum CancelDataOwnerUpdateRequestOpExt: XDRDiscriminatedUnion {
    case emptyVersion
