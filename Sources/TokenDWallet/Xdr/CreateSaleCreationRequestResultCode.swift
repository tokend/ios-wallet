...
public enum CreateSaleCreationRequestResultCode: Int32, XDREnum {
  ...
  case exceededMaxRulesSize = -17
  case globalSpecificRuleDuplication = -18
  case accountSpecificRuleDuplication = -19
  case globalSpecificRuleRequired = -20
  case accountNotFound = -21
}
