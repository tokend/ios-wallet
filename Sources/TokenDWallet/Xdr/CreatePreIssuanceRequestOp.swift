...
//  ===========================================================================
public struct CreatePreIssuanceRequestOp: XDRCodable {
  ...
  public init(xdrData: inout Data) throws {
    self.request = try PreIssuanceRequest(xdrData: &xdrData)
    if (try Bool(xdrData: &xdrData)) {
      self.allTasks = try Uint32(xdrData: &xdrData)
    } else {
      self.allTasks = nil
    }
    self.ext = try CreatePreIssuanceRequestOpExt(xdrData: &xdrData)
  }
