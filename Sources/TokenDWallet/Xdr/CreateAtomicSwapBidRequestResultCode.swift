...
//  ===========================================================================
public enum CreateAtomicSwapBidRequestResultCode: Int32, XDREnum {
  case success = 0
  case invalidBaseAmount = -1
  case invalidQuoteAsset = -2
  case askNotFound = -3
  case quoteAssetNotFound = -4
  case askUnderfunded = -5
  case atomicSwapBidTasksNotFound = -6
  case incorrectPrecision = -7
  case askIsCancelled = -8
  case sourceAccountEqualsAskOwner = -9
  case atomicSwapBidZeroTasksNotAllowed = -10
  case quoteAmountOverflows = -11
}
