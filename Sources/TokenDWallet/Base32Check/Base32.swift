...
internal func base32Encode(_ data: Data) -> String {
    return data.withUnsafeBytes {
        base32encode(UnsafeRawPointer($0), data.count, alphabetEncodeTable)
    }
}

internal func base32HexEncode(_ data: Data) -> String {
    return data.withUnsafeBytes {
...
internal func base32Encode(_ array: [UInt8]) -> String {
    return base32encode(array, array.count, alphabetEncodeTable)
}

internal func base32HexEncode(_ array: [UInt8]) -> String {
    return base32encode(array, array.count, extendedHexAlphabetEncodeTable)
}

internal func base32Decode(_ string: String) -> [UInt8]? {
    return base32decode(string, alphabetDecodeTable)
}

internal func base32HexDecode(_ string: String) -> [UInt8]? {
...
let extendedHexAlphabetDecodeTable: [UInt8] = [
    ...
    __, __, __, __, __, __, __, __, __, __, __, __, __, __, __, __,  // 0x10 - 0x1F
    __, __, __, __, __, __, __, __, __, __, __, __, __, __, __, __,  // 0x20 - 0x2F
    00,  1,  2,  3,  4,  5,  6,  7,  8,  9, __, __, __, __, __, __,  // 0x30 - 0x3F
...
// swiftlint:enable identifier_name comma
...
private func base32decode(_ string: String, _ table: [UInt8]) -> [UInt8]? {
    ...
    if let index = string.unicodeScalars.index(where: {$0.value > 0xff || table[Int($0.value)] > 31}) {
        ...
        if pos != length - leastPaddingLength {
            print("- error - string contains some invalid characters.")
            return nil
        }
    }
    ...
    default:
        print("- error - string length is invalid.")
        return nil
    }
